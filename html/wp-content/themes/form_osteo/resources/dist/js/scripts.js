...
var header = {
  ...
  headerFixed: function headerFixed() {
    console.log('scroll');
...
window.$ = window.jQuery = _jquery["default"]; // Require modules
...
},{"./modules/header.js":1,"jquery":3}],3:[function(require,module,exports){
/*!
